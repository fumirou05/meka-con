...
void unload();
void release();
void setOnLineForward();
void setOnLineBackward();
  ...
  while (true) {
    ...
    if (black <= 1) {
      ...
      if (rotate <= 0) {
        ...
        digitalWrite(MOTORR00, 0);
        digitalWrite(MOTORR01, 1);
        analogWrite(MOTORL, 1 * rotate * (-1));
        analogWrite(MOTORR, 1 * rotate * (-1)); 
      } else {
        digitalWrite(MOTORL00, 0);
        digitalWrite(MOTORL01, 1);
        digitalWrite(MOTORR00, 1);
        digitalWrite(MOTORR01, 0);
        analogWrite(MOTORL, 1 * rotate);
        analogWrite(MOTORR, 1 * rotate);
      }
    }
    delay(10);
  }
